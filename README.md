...
```
Схема данных и тестовые данные пользователей, организаций и связей между ними будут созданы автоматически.
...
## Задание
В папке `task` размещена задача. `README.md` обновлен в соответствии с выполненными заданиями (основными и дополнительными).
